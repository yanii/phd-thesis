...
\section{Growing Neural Network Architectures}
	...
	\subsection{Tiling Algorithm}\label{tilingalgo}
	...
	\subsection{Upstart}
	The Upstart algorithm is a method for building neural networks using \emph{\gls{ltu}}\index{LTU}, a neuron , at a high level like the Tiling Algorithm\cref{tilingalgo}, but instead of building up layers from the input, 
