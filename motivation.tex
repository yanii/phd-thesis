...
\section{Growing Neural Network Architectures}
	...
	\begin{figure}[tbp]
		...
		\caption[Cascade correlation.]{\textbf{Cascade Correlation.} Connections marked with a $\square$ are frozen, while $\times$ connections are learned continously. \copyright~\citet{Fahlman1989}}
