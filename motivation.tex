...
%    we can see that the number of training samples required to guarantee this error rate are proportional to the logarithm of the number of inputs and the , 
	...
	One of the more interesting recent papers on generalization in \gls{dnn} highlights that \glspl{dnn} may not always be learning the representations we want them to. \Citet{rethinking2016} looked at the effect of training \glspl{dnn}
	\mynote{TODO}
