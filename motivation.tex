...
\section{Growing Neural Network Architectures}
	...
	One of the earliest proposals for building neural network structures from the data itself is \emph{tiling} algorithm. The tiling algorithm is guaranteed to converge on perfect classification of the training set (not necessarily good for generalization). 
