...
\begin{document}
    ...
    This result, while surprising given the typical VC dimension of neural networks, supports empirical results in using contemporary training methods such as weight decay~\citep{hinton1987learning,}\todo{Add references}, early stopping, and even more recently batch normalization~\citep{Ioffe2015}, all of which keep weight magnitudes low.
%    For a single hidden layer network, \ie $\ell=2$, and an error rate of $\epsilon=0.05$, 
