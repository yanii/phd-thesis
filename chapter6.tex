...
\paragraph{ResNet-50.}
Figure \ref{fig:resnet50ablation_conv1_top5} shows the results of pairwise ablation on a Resnet-50~\citet{He2015} network trained on ILSVRC2012, on both the training set (\cref{fig:resnet50ablation_conv1_top5_train},\ref{fig:resnet50ablation_conv1_top5_train_hist}) and validation set (\cref{fig:resnet50ablation_conv1_top5_test},\ref{fig:resnet50ablation_conv1_top5_test_hist}).
