...
\end{axis}
\end{tikzpicture}
\caption{\Glsfmtshort{cifar10} Training Error}
...
\end{axis}
\end{tikzpicture}
\caption{\Glsfmtshort{cifar10} Test Error}
\label{fig:cifar_dropproject_test_acc}
\end{subfigure}
\caption[Dropout \vs dropproject for VGG/\Glsfmtshort{cifar10}]{Training and test curves for a VGG network on \Glsfmtshort{cifar10} comparing dropout to dropproject.}
