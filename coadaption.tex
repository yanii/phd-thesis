...
\end{subfigure}
\caption[Dropout \vs dropproject for VGG/\Glsfmttext{cifar10}]{Training and test curves for a VGG network on \Glsfmttext{cifar10} comparing dropout to dropproject.}
