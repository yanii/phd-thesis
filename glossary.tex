...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SYMBOLS
\glsxtrnewsymbol[description={The height of a convolutional \gls{feature map}}]{H}{\ensuremath{H}}
\glsxtrnewsymbol[description={The width of a convolutional \gls{feature map}}]{W}{\ensuremath{W}}
\glsxtrnewsymbol[description={The height of a convolutional \gls{filter}}]{h}{\ensuremath{h}}
\glsxtrnewsymbol[description={The width of a convolutional \gls{filter}}]{w}{\ensuremath{w}}
%\newglossaryentry{fheight}{name={h}, type=symbols, symbol={\ensuremath{h}}, description={The height of a convolutional \gls{filter}}}
%\newglossaryentry{fwidth}{name={w}, type=symbols, symbol={\ensuremath{w}}, description={The width of a convolutional \gls{filter}}}