...
\begin{description}
	...
	\item[Chapter \ref{pairablation}] presents the initial findings from ongoing research investigating neural co-dependence in neural networks. Some surprising findings on both filter co-adaption and dropout are shown, but these are preliminary.
