...
\addplot[style={black,fill=\colora,opacity=0.5,mark=none},area legend] table[x expr=3*\coordindex,y=Multiply-Accumulate]{\datatable};\label{maaxis}
\end{axis}
...
\addplot+[style={black,fill=\colorb,opacity=0.5,mark=none},area legend] table[x expr=3*\coordindex+1,y=CPU Timing]{\datatable};\label{cpuaxis}
\end{axis}
...
\addplot[style={black,fill=\colorc,opacity=0.5},area legend] table[x expr=3*\coordindex+2,y=GPU Timing]{\datatable};\label{gpuaxis}
\addlegendentry{GPU}
\end{axis}
\end{tikzpicture}
}
