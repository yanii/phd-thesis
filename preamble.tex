...
\newcommand{\colora}{Set2-A}
\newcommand{\colorb}{Set2-B}
\newcommand{\colorc}{Set2-C}
...
\stringcases
  {#1}%
  {%
    {1}{cycle list name = Set2-3}%
    {2}{cycle list name = Set2-3}
    {3}{cycle list name = Set2-3}%
    {4}{cycle list name = Set2-4}%
    {5}{cycle list name = Set2-5}%
    {6}{cycle list name = Set2-6}%
    {7}{cycle list name = Set2-7}%
    {8}{cycle list name = Set2-8}%
  }%
