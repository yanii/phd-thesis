...
\begin{document}
    ...
    In what follows, we compare the accuracy of a number of different network architectures detailed in  Table~\ref{table:vggarch}. Results for ILSVRC are given in Table~\ref{table:vggimagenetresults}, and plotted in \cref{fig:vggplots}. Results for MIT Places are given in Table \ref{table:placesresults}, and plotted in \cref{fig:placesresults}. 
...
%    \input{lrdata/cifarplots}
    The results of our CIFAR experiments are listed in Table~\ref{table:cifarresultsch4} and plotted in \cref{fig:cifarresultsch4}.
