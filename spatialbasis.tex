...
\begin{document}
    ...
    \section[Training CNNs with Mixed-Shape Low-Rank Filters]{Training CNNs with Mixed-Shape\\Low-Rank Filters}%\section{Initializing CNNs with Mixed-Shape Low-Rank Filters}\label{initializationderivation}
