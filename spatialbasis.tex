...
\begin{document}
    ...
    \subsubsection{\Glsfmtshort{vgg}-derived Model Table}
\begin{table}[tbp]
    \centering
    \caption[Low-rank \Glsfmtshort{vgg} \Glsfmtshort{ilsvrc} results]{\textbf{\Glsfmtshort{vgg} \glsfmtshort{ilsvrc} Results.} Accuracy, multiply-accumulate count, and number of parameters for the baseline VGG-11 network (both with and without global max pooling) and more efficient versions created by the methods described in this chapter.}\label{table:vggimagenetresults}
...
\afterpage{\begin{landscape}
    ...
    \subsection{GoogLeNet for \Glsfmtshort{ilsvrc} Object Classification}
    ...
    \begin{table}[tbp]
        \centering
        \caption[Low-rank \Glsfmtshort{googlenet} \Glsfmtshort{ilsvrc} results]{\textbf{\Glsfmtshort{googlenet} \glsfmtshort{ilsvrc} Results.} Accuracy, multiply-accumulate count, and number of parameters for the baseline GoogLeNet network and more efficient versions created by the methods described in this chapter.
        }
%        \resizebox{\textwidth}{!}{
...
%        }
    ...
    \begin{figure}[tbp] 
        ...
        \caption[Low-Rank \Glsfmtshort{googlenet} \glsfmtshort{ilsvrc} results]{\textbf{\Glsfmtshort{googlenet} \glsfmtshort{ilsvrc} Results.} Multiply-accumulate operations \vs top-5 error for GoogLeNet-derived models on \gls{ilsvrc} object classification dataset.}
        \label{fig:googlenetimagenetresultsch4}
    \end{figure}
    
    \subsection{\Glsfmtshort{nin} for \Glsfmtshort{cifar10} Object Classification}
    ...
    \begin{table}[tbp]
        \centering
        \caption[Low-rank \Glsfmtshort{cifar10} results]{\textbf{\Glsfmtshort{nin} \glsfmtshort{cifar10} Results.} Accuracy, multiply-accumulate operations, and number of parameters for the baseline \gls{nin} model and more efficient versions created by the methods described in this chapter.}
        %\resizebox{\textwidth}{!}{
    ...
    \begin{figure}[tbp] 
        ...
        \end{axis}
        \end{tikzpicture}
        \caption[Low-rank \Glsfmtshort{cifar10} results]{\textbf{\Glsfmtshort{nin} \glsfmtshort{cifar10} Results.} Multiply-accumulate operations \vs error for \gls{nin} derived models on \gls{cifar10} object classification dataset.}
