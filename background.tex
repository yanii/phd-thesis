...
\begin{equation}
	y_j = f\left( a_i \right),
\end{equation}
where
\begin{equation}
	a_i = \sum_i w_{ji} x_{i}.
\end{equation}
...
\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w^n_{ji}} &= \frac{\partial E^n_j}{\partial e^n_j}\frac{\partial e^n_j}{\partial y^n_j} \frac{\partial y^n_j}{\partial a^n_j} \frac{\partial a^n_j}{\partial w_{ji}},& \textrm{(chain rule)}\\
