...
\begin{equation}
\begin{aligned}
    \Delta \gls{w}_{ji} &= -\gamma \frac{\partial \gls{E}^n}{\partial \gls{w}_{ji}},
\end{aligned}
\end{equation}
%
...
\begin{equation}
\begin{aligned}
    \Delta \gls{w}_{ji} &= -\gamma \gls{delta}^n_j x_i.
\end{aligned}
\end{equation}
%
...
\begin{equation}
\begin{aligned}
    \frac{\partial \gls{E}^n}{\partial \gls{w}_{kj}} &= \frac{\partial E^n}{\partial a^n_k} \frac{\partial a^n_k}{\partial w_{kj}}\\
...
\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w_{ji}} &= \left( \sum_k \gls{delta}^n_k y^n_j \frac{\partial a^n_k}{\partial y^n_{j}}\right)
...
\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w_{ji}} &= \left( \sum_k \gls{delta}^n_k y^n_j w_{kj}\right)
...
\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w_{ji}} &=  \gls{delta}^n_j x_i.
     \label{eqn:twolayer4}
\end{aligned}
\end{equation}
%
...
\gls{delta}^n_i = \begin{cases}
        ...
        f'\left( a^n_j \right) \left( \sum_j \gls{delta}^n_j y^n_i w_{ji} \right)& \textrm{when neuron\index{neuron} $j$ is hidden},
        \end{cases}
...
\begin{equation}
\begin{aligned}
    \Delta w_{ij} &= -\gls{lr}\frac{1}{T} \sum^T_{n=0} \frac{\partial E^n}{\partial w_{ji}},
...
\begin{equation}
\begin{aligned}
    \Delta w_{ij} &= -\gls{lr} \frac{1}{|X_{\textrm{mb}}|} \sum_{\{n|\,\gls{vectorx}^n \in X_{\textrm{mb}}\}} \frac{\partial E^n}{\partial w_{ji}},
     \label{eqn:sgdrule}
\end{aligned}
\end{equation}
