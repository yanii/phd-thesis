...
\phantomsubcaption\label{fig:resnet-1}
\end{subfigure}
\hfill
\begin{subfigure}[T]{0.3\textwidth}
\centering
\includegraphics[height=0.33\textheight]{resnet-2}
\phantomsubcaption\label{fig:resnet-2}
\end{subfigure}
\hfill
\begin{subfigure}[T]{0.3\textwidth}
\centering
\includegraphics[height=0.33\textheight]{resnet-3}
\phantomsubcaption\label{fig:resnet-3}
\end{subfigure}
