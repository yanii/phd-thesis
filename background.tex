...
Assuming we are attempting to work out the partial $\frac{\partial E^n}{\partial w_{ji}}$, for a single hidden layer network illustrated in Fig.~\ref{fig:neurontwolayer}. We can again derive the derivative of a hidden layer weight using chain rule,

\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w_{ji}} &= \frac{\partial E^n}{\partial e^n_{k}}
     \frac{\partial x^n_{kj}}{\partial a^n_{j}} \frac{\partial a^n_{j}}{\partial w_{ji}}
\end{aligned}
\end{equation}
