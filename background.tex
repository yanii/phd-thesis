...
Some network architectures are sufficiently complex, e.g.~networks with neurons with drastically different number of outgoing/incoming connections, that even careful initialization will not prevent exploding/vanishing gradients. Instead, a more direct approach of managing gradient amplitude during training was introduced by \citet{Ioffe2015}. 

\mynote{TODO} %unit gaussian activations across all features of the layer
...
\matrix[column sep=0em]{
	...
	\node (1c) {
		\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=22]{groupfig}}\hspace{1em}\raisebox{-0.5\height}{$\cdots$}
	};
	\\
	...
	\node (2a) {
		\raisebox{-0.5\height}{$\cdots$}\hspace{1em}\raisebox{-0.5\height}{\includegraphics[height=0.09\textwidth, page=16]{groupfig}}
	};\&
	\node (2b) {
    ...
    \&\node (3c) {
		\raisebox{-0.5\height}{$\cdots$}\hspace{1em}\raisebox{-0.5\height}{\includegraphics[height=0.09\textwidth, page=20]{groupfig}}
	};\\
