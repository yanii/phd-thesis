...
\begin{aligned}
    ...
    =& -\sum_k \frac{\partial E^n}{\partial e^n_{k}} \frac{\partial e^n_{k}}{\partial y^n_{k}} \frac{\partial y^n_{k}}{\partial a^n_k}\\
    =& -\sum_k \delta^n_k y^n_j w_{kj}.
\end{aligned}
\end{equation}

This leaves us with the more convenient expression,
\begin{equation}
\begin{aligned}
    \frac{\partial E^n}{\partial w_{ji}} &=  \delta^n_j f'\left( a^n_j \right) x_i.
     \label{eqn:twolayer3}
\end{aligned}
\end{equation}
