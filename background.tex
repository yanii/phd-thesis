...
\begin{figure}[tbp]
    \centering
    \newcommand{\layer}{\includegraphics[width=0.3\textwidth, page=1, viewport = 0 0 440 600, clip=true]{layer}}
	\parbox{\widthof{\layer}}{\layer}\parbox{\widthof{\layer}}{\layer}\ldots\parbox{\widthof{\layer}}{\layer}
