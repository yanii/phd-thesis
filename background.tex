...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.82\textwidth]{learningratedecrease}
...
\begin{figure}[tbp]
    \centering
    \newcommand{\layer}{\includegraphics[width=0.29\textwidth]{layer}}
...
\begin{figure}[tbp]
\centering
% \includegraphics[width=0.95\linewidth]{ninarchitecture}
\begin{tikzpicture}[ampersand replacement=\&]
\begin{scope}[]
\matrix[column sep=0em]{
	\node (1a) {
