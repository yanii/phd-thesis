...
\caption[Learning rate and convergence.]{\textbf{An illustration of the effect of step size (learning rate) on convergence with backpropagation.} Too small a step size can result in very slow learning, while too large a step size can result in bouncing around the minima, or missing the it altogether.}
