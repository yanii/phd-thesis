...
\begin{figure}[tbp]
	...
	\begin{subfigure}[t]{0.48\textwidth}
		...
		\end{axis}
		\end{tikzpicture}
		\caption{Derivative $\frac{\diff}{\diff\gls{a}} \left(\tanh\left(\gls{a}\right)\right)$}\label{fig:tanhgradients}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.48\textwidth}
		\begin{tikzpicture}[
		...
		\end{axis}
		\end{tikzpicture}
		\caption{Derivative $\frac{\diff}{\diff\gls{a}} \left(\max(0,\gls{a})\right)$}\label{fig:relugradient}
	\end{subfigure}
