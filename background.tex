...
We will not cover the long and colourful history of neural networks, but attempt to instead provide an overview of contemporary models and methods directly relevant to this work. For a comprehensive overview of the basics of neural networks we refer the reader to the excellent reference of~\citet{Bishop1995}, and for a more recent  in-depth overview of the field of \emph{deep learning}, we refer the reader to~\citet{goodfellow2016deep}.
...
This function also has a geometric interpretation~\citet{Bishop1995}. In 2D, for example, this is equivalent to the equation of the line. If we define $a=w_0, x=x_0, c=b$,
