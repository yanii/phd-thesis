...
\end{scope}
\end{tikzpicture}
\caption[Network in Network architecture.]{\textbf{Network-in-Network Architecture.}  Coloured blocks represent the filters of each layer, grey blocks the intermediate feature maps over which a layer's filters operate.
}
