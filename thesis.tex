...
\documentclass[a4paper,12pt,customfont,print,index,custombib,draft]{Classes/PhDThesisPSnPDF}
%\documentclass[a4paper,12pt,times,print,index,authoryear]{Classes/PhDThesisPSnPDF}
...
%Conditional networks (methodology)
%• The model
...
\subfile{motivation}
% Structural Priors
% - Weak: regularization, soft conditional computation
% - Strong: Structural, hard conditional computation
