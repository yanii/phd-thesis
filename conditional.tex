...
\begin{document}
	...
	%GoogLeNet (see \cref{fig:Imagenet_results}). Network in Network and GoogLeNet pioneered the use of semi-dense 
	...
	%the majority of weights in the network (see \cref{fig:VggPerLayerCost}), and is the single largest factor in the space efficiency of Network in Network and GoogLeNet.
