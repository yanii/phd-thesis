...
\begin{document}
	...
	Starting from the already improved, non-routed VGG11-GMP architecture, we designed the conditional network in Fig.~\ref{fig:Imagenet_CondNet}.
	% figure 
	\begin{figure}[tbp]
		\centering
	...
	GoogLeNet and Alexnet~\citep{Krizhevsky2012imanet} (in light blue) are in fact instances of conditional networks 
