...
\begin{document}
    ...
    \begin{table}[tbp]
        \centering
        \caption[Conditional Network \Glsfmttext{ilsvrc} results]{\textbf{Conditional network \glsfmttext{ilsvrc} Results.} Accuracy, multiply-accumulate count, and number of parameters for the baseline networks and more efficient versions created by the methods described in this chapter.
        }
%        \resizebox{\textwidth}{!}{
        ...
        columns={Network Name, Stride, Top-1 Error (centre crop), Top-5 Error (centre crop), Multiply-Acc Ops, Num Parameters},
        ...
        column type/.add={lrp{3.5em}p{3.5em}p{3em}p{3em}}{},
