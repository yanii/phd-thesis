...
\begin{document}
	...
	\begin{figure}[tbp]
		\centering
		\begin{subfigure}[b]{\textwidth}
			\pgfplotstableread[col sep=comma,]{condnetdata/condnetdata.csv}\datatablea
			...
			\begin{axis}[
				...
				axis x line=bottom,
				ylabel=Top-5 (Centre-Crop) Error,
		...
		\begin{subfigure}[b]{0.98\linewidth}
			...
			\legend{stride-1, stride-2, stride-4}
			\end{axis}
			\end{tikzpicture}
