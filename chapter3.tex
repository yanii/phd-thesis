...
\begin{document}
	...
	except for using the initialization strategy suggested of~\cite{He2015b}, and a learning schedule of 
	...
	Note that the most efficient model in~\cite{He2015b} uses 1.9E+10 flops which is just outside the plot. 
	More accurate versions of~\cite{He2015b} are more expensive still.
	...
	except for using the initialization strategy of~\cite{He2015b}, 
