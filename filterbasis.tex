...
\begin{document}
	...
	\begin{figure}[tb]
		\begin{subfigure}[b]{\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth, page=1]{Figs/PDF/groupfig}
			\caption{Convolution}\label{fig:normalconv}
		\end{subfigure}
		~
		\begin{subfigure}[b]{\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth, page=2]{Figs/PDF/groupfig}
	...
	\begin{figure}[tb]
		...
		\end{axis}
		\end{tikzpicture}
		\caption[AlexNet performance and filter groups.]{\textbf{AlexNet Filter Groups.} Model Parameters \vs top-5 error for variants of the AlexNet model on ILSVRC image classification dataset. Models with moderate numbers of filter groups have far fewer parameters, yet surprisingly maintain comparable error.}\label{fig:alexnetplots}
	\end{figure}
	...
	\begin{landscape}
		\begin{figure}[p]
			...
			\begin{subfigure}[b]{0.32\linewidth}
				...
				\caption{Root-2}\label{fig:root2corrfull}
			\end{subfigure}
			~
			\begin{subfigure}[b]{0.32\linewidth}
				\centering
				...
				\caption{Root-4}\label{fig:root4corrfull}
			\end{subfigure}
			~
			\begin{subfigure}[b]{0.32\linewidth}
				\centering
				...
				\caption{Root-8}\label{fig:root8corrfull}
			\end{subfigure}
			~
			\begin{subfigure}[b]{0.32\linewidth}
				\centering
				...
				\caption{Root-16}\label{fig:root16corrfull}
			\end{subfigure}
			~
			\begin{subfigure}[b]{0.32\linewidth}
				\centering
