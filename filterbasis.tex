...
\begin{document}
	...
	\end{figure}
    \mynote{Change this to refer to chapter instead of paper}
	...
	\afterpage{%
		\begin{landscape}
			\begin{figure}[p]
				...
				\end{subfigure}
				\centering
				\includegraphics[width=0.4\textwidth]{Figs/PDF/colorbar}
	...
	\begin{figure}[p]
		\begin{subfigure}[c]{0.9\textwidth}
			...
			\matrix[column sep=0em]{
				\node (1a) {
					\raisebox{-0.5\height}{\includegraphics[height=0.08\textwidth, page=15]{Figs/PDF/groupfig}}
				};\&
				\node (1b) {
					\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}}
				};\&
				\node (1c) {
					\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}}
				};\&
				\node (2a) {
					\raisebox{-0.5\height}{\includegraphics[height=0.09\textwidth, page=16]{Figs/PDF/groupfig}}
				};\&
				\node (2b) {
					\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}}
				};\&
		...
		\begin{subfigure}[c]{0.9\textwidth}
			...
			\matrix[column sep=0em]{
				\node (1a) {
					\includegraphics[height=0.08\textwidth, page=15]{Figs/PDF/groupfig}
				};\&
				\node (1b) {
					\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}
				};\& 
				\node (1c) {
					\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}
				};\& 
				\node (2a) {
					\includegraphics[height=0.15\textwidth, page=19]{Figs/PDF/groupfig}
				};\&
				\node (2b) {
					\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}
				};\&
				...
				\node (3a) {
					\includegraphics[height=0.09\textwidth, page=18]{Figs/PDF/groupfig}
				};\&
				\node (3b) {
					\includegraphics[height=0.11\textwidth, page=17]{Figs/PDF/groupfig}
				};\&
