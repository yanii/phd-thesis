	...
	\begin{figure}[p]
		\begin{subfigure}[c]{0.9\textwidth}
			...
			\matrix[column sep=0em]{
				...
				\node (1b) {
					\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=17]{groupfig}}
				};\&
				\node (1c) {
					\raisebox{-0.5\height}{\includegraphics[height=0.11\textwidth, page=17]{groupfig}}
				};\&
		...
		\begin{subfigure}[c]{0.9\textwidth}
			...
			\matrix[column sep=0em]{
				\node (1a) {
					\includegraphics[height=0.08\textwidth, page=15]{groupfig}
				};\&
				\node (1b) {
					\includegraphics[height=0.11\textwidth, page=17]{groupfig}
				};\& 
				\node (1c) {
					\includegraphics[height=0.11\textwidth, page=17]{groupfig}
				};\& 
				\node (2a) {
					\includegraphics[height=0.15\textwidth, page=19]{groupfig}
				};\&
				\node (2b) {
					\includegraphics[height=0.11\textwidth, page=17]{groupfig}
				};\&
				...
				\node (3a) {
					\includegraphics[height=0.09\textwidth, page=18]{groupfig}
				};\&
				\node (3b) {
					\includegraphics[height=0.11\textwidth, page=17]{groupfig}
				};\&
