...
\begin{document}
	...
	\begin{figure}[tbp]
		...
		\caption[Learning a spatial basis for filters]{\textbf{Learning a spatial basis for filters.} Learning a linear combination of mostly small, heterogeneously-sized spatial filters, as proposed in \cref{lowrankfilters}. Note that all filters operate on all $c$ channels of the input feature map\index{feature map}.}
