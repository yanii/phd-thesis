...
\begin{document}
	...
	\end{table}
	\begin{table}[tp]
		\caption[\Gls{nin} CIFAR10 results.]{\textbf{\Gls{nin} CIFAR10}}
	...
	\begin{figure}[tbp]
		...
		\caption[\Gls{nin} CIFAR10 results.]{\textbf{\Gls{nin} CIFAR10 Results.} Spatial filters (3$\times$3, 5$\times$5) are grouped hierarchically. The best models are closest to the origin. For the standard network, the mean and standard deviation (error bars) are shown over 5 different random initializations.
	...
	\begin{figure}[tbp]
		...
		\end{subfigure}
		\caption[ResNet 50 layer-wise FLOPS/parameters.]{\textbf{ResNet 50 Layer-wise FLOPS/Parameters.} 
		}
