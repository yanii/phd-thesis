...
\begin{document}
	...
	%\caption{This work introduces the idea of using hierarchical filter group\index{filter groups}ing to create \glsfmtshort{cnn} connection structures that resemble tree roots. Applying the technique to existing state-of-the-art networks allows improved efficiency without compromising accuracy.}
	%\label{fig:tree}
	%\end{figure}
	...
	In this chapter we show that simple alterations to the architecture of state-of-the-art \glspl{cnn}\index{CNN} for image recognition can drastically reduce computational cost and model size while maintaining (or even increasing) accuracy, through structure-induced regularization, by reducing the connectivity in monolithic networks to reflect more closely the sparse, localized filter co-dependencies within a trained network.
	...
	\subsection{Improving \Glsfmtshort{nin} on \Glsfmtshort{cifar10}}
	...
	\begin{table}[tbp]
		\caption[\Glsfmtshort{nin} root architectures]{\textbf{\Glsfmtshort{nin} Root Architectures}. Filter groups\index{filter groups} in each convolutional layer.}
	...
	\end{table}
	\begin{table}[tp]
		\caption[\Glsfmtshort{nin} \gls{cifar10} results]{\textbf{\Glsfmtshort{nin} \glsfmtshort{cifar10} Results}}
	...
	\begin{figure}[tbp]
		...
		\begin{subfigure}[b]{0.3\textheight}
			\centering
			\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=\textwidth]{Figs/PDF/ninroot32/layercovar_conv8}}
		...
		\begin{subfigure}[b]{0.3\textheight}
			\centering
			\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=\textwidth]{Figs/PDF/ninroot32/layercovarwhite_conv8}}
			\caption{Whitened responses}
			\label{fig:whitened}
		\end{subfigure}
		\caption[Inter-layer covariance with/without whitened responses]{Covariance for between two layers in the root-32 \glsfmtshort{nin} model with and without whitened responses.}
	    ...
	    \begin{landscape}
			\begin{figure}[p]
				\begin{subfigure}[c]{0.75\paperheight}
					\centering
    				\vspace{0.6em}
					\covarlabels{conv1a}{192}{conv1a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv0}}
					~
					\covarlabels{conv1b}{160}{conv1b}{160}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv1}}
					~
					\covarlabels{conv1c}{96}{conv1c}{96}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv2}}
					~
					\covarlabels{conv2a}{192}{conv2a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv4}}
					~
					\covarlabels{conv2b}{192}{conv2b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv5}}
					~
					\covarlabels{conv2c}{192}{conv2c}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv6}}
					~
					\covarlabels{conv3a}{192}{conv3a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv8}}
					~
					\covarlabels{conv3b}{192}{conv3b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/nin/corrcoef_conv9}}
					\caption{\Glsfmtshort{nin}}\label{fig:corrroot1}
    				\vspace{0.6em}
				\end{subfigure}\\
				\begin{subfigure}[c]{0.75\paperheight}
					\centering
    				\vspace{0.6em}
					\covarlabels{conv1a}{192}{conv1a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv0}}
					~
					\covarlabels{conv1b}{160}{conv1b}{160}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv1}}
					~
					\covarlabels{conv1c}{96}{conv1c}{96}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv2}}
					~
					\covarlabels{conv2a}{192}{conv2a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv4}}
					~
					\covarlabels{conv2b}{192}{conv2b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv5}}
					~
					\covarlabels{conv2c}{192}{conv2c}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv6}}
					~
					\covarlabels{conv3a}{192}{conv3a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv8}}
					~
					\covarlabels{conv3b}{192}{conv3b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot4/corrcoef_conv9}}
				...
				\begin{subfigure}[c]{0.75\paperheight}
					\centering
    				\vspace{0.6em}
					\covarlabels{conv1a}{192}{conv1a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv0}}
					~
					\covarlabels{conv1b}{160}{conv1b}{160}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv1}}
					~
					\covarlabels{conv1c}{96}{conv1c}{96}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv2}}
					~
					\covarlabels{conv2a}{192}{conv2a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv4}}
					~
					\covarlabels{conv2b}{192}{conv2b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv5}}
					~
					\covarlabels{conv2c}{192}{conv2c}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv6}}
					~
					\covarlabels{conv3a}{192}{conv3a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv8}}
					~
					\covarlabels{conv3b}{192}{conv3b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot8/corrcoef_conv9}}
				...
				\begin{subfigure}[c]{0.75\paperheight}
					\centering
    				\vspace{0.6em}
					\covarlabels{conv1a}{192}{conv1a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv0}}
					~
					\covarlabels{conv1b}{160}{conv1b}{160}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv1}}
					~
					\covarlabels{conv1c}{96}{conv1c}{96}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv2}}
					~
					\covarlabels{conv2a}{192}{conv2a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv4}}
					~
					\covarlabels{conv2b}{192}{conv2b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv5}}
					~
					\covarlabels{conv2c}{192}{conv2c}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv6}}
					~
					\covarlabels{conv3a}{192}{conv3a}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv8}}
					~
					\covarlabels{conv3b}{192}{conv3b}{192}{\includegraphics[width=0.11\linewidth]{Figs/PDF/ninroot32/corrcoef_conv9}}
				...
				\end{subfigure}
				\caption[Intra-layer filter correlation]{\textbf{\Glsfmtshort{nin} Intra-Layer Correlation.} Absolute correlation of filters within each layer of a NiN model variant.}
				\label{fig:nincorr}
			\end{figure}
		\end{landscape}
		\begin{landscape}
			\begin{figure}[p]
				\begin{subfigure}[c]{0.88\paperheight}
					%\centering
					\covarlabels{conv1a}{192}{conv1b}{160}{\includegraphics[width=0.1\linewidth]{Figs/PDF/nin/layercovarwhite_conv1}}
					~
					\covarlabels{conv1b}{160}{conv1c}{96}{\includegraphics[width=0.05\linewidth]{Figs/PDF/nin/layercovarwhite_conv2}}
					~
					\covarlabels{conv1c}{96}{conv2a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/nin/layercovarwhite_conv4}}
					~
					\covarlabels{conv2a}{192}{conv2b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/nin/layercovarwhite_conv5}}
					~
					\covarlabels{conv2b}{192}{conv2c}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/nin/layercovarwhite_conv6}}
					~
					\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/nin/layercovarwhite_conv8}}
					~
					\covarlabels{conv3a}{192}{conv3b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/nin/layercovarwhite_conv9}}
					~
					\covarlabels{}{192}{}{10}{\includegraphics[width=0.00624996\linewidth]{Figs/PDF/nin/layercovarwhite_conv10}}
					\caption{\Glsfmtshort{nin}}
					\vspace*{0.6em}
					\label{fig:covaroot1}
				\end{subfigure}
				~
				\begin{subfigure}[c]{0.88\paperheight}
					%\centering
					\covarlabels{conv1a}{192}{conv1b}{160}{\includegraphics[width=0.1\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv1}}
					~
					\covarlabels{conv1b}{160}{conv1c}{96}{\includegraphics[width=0.05\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv2}}
					~
					\covarlabels{conv1c}{96}{conv2a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv4}}
					~
					\covarlabels{conv2a}{192}{conv2b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv5}}
					~
					\covarlabels{conv2b}{192}{conv2c}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv6}}
					~
					\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv8}}
					~
					\covarlabels{conv3a}{192}{conv3b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv9}}
					~
					\covarlabels{}{192}{}{10}{\includegraphics[width=0.00624996\linewidth]{Figs/PDF/ninroot4/layercovarwhite_conv10}}
					\caption{Root-4}
					\vspace*{0.6em}
				...
				\begin{subfigure}[c]{0.88\paperheight}
					%\centering
					\covarlabels{conv1a}{192}{conv1b}{160}{\includegraphics[width=0.1\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv1}}
					~
					\covarlabels{conv1b}{160}{conv1c}{96}{\includegraphics[width=0.05\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv2}}
					~
					\covarlabels{conv1c}{96}{conv2a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv4}}
					~
					\covarlabels{conv2a}{192}{conv2b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv5}}
					~
					\covarlabels{conv2b}{192}{conv2c}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv6}}
					~
					\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv8}}
					~
					\covarlabels{conv3a}{192}{conv3b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv9}}
					~
					\covarlabels{}{192}{}{10}{\includegraphics[width=0.00624996\linewidth]{Figs/PDF/ninroot8/layercovarwhite_conv10}}
					\caption{Root-8}
					\vspace*{0.6em}
				...
				\begin{subfigure}[c]{0.88\paperheight}
					%\centering
					\covarlabels{conv1a}{192}{conv1b}{160}{\includegraphics[width=0.1\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv1}}
					~
					\covarlabels{conv1b}{160}{conv1c}{96}{\includegraphics[width=0.05\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv2}}
					~
					\covarlabels{conv1c}{96}{conv2a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv4}}
					~
					\covarlabels{conv2a}{192}{conv2b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv5}}
					~
					\covarlabels{conv2b}{192}{conv2c}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv6}}
					~
					\covarlabels{conv2c}{192}{conv3a}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv8}}
					~
					\covarlabels{conv3a}{192}{conv3b}{192}{\includegraphics[width=0.12\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv9}}
					~
					\covarlabels{}{192}{}{10}{\includegraphics[width=0.00624996\linewidth]{Figs/PDF/ninroot32/layercovarwhite_conv10}}
					\caption{Root-32}
					\label{fig:covarroot32}
				\end{subfigure}
				\caption[Inter-layer covariance (all layers)]{\textbf{\Glsfmtshort{nin} Inter-layer Covariance.} The inter-layer covariance for all layers in variants of the NiN network.}
	...
	\subsection{Improving Residual Networks on \Glsfmtshort{ilsvrc}}
	...
	\begin{table}[tp]
		\caption[ResNet 50 \Glsfmtshort{ilsvrc} Results]{\textbf{ResNet 50 Results.}}
		...
		column type/.add={@{}llp{3em}lp{3em}rrrr@{}}{},
	...
	\begin{figure}[p]
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\legend{ResNet 50, Roots}
			\end{axis}
			\end{tikzpicture}
			\caption{Model Parameters \vs Top-5 Error}
			\label{fig:resnet50param}
		\end{subfigure}
		~
		\begin{subfigure}[b]{\textwidth}
			\pgfplotstableread[col sep=comma]{rootdata/resnet50ma.csv}\gdatatable
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\Glsfmtshort{flops} (Multiply-Add) \vs Top-5 Error}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\Glsfmtshort{gpu} Forward Time \vs Top-5 Error}
			\label{fig:resnet50gpuforward}
		\end{subfigure}
		~
		\begin{subfigure}[b]{\textwidth}
			\pgfplotstableread[col sep=comma]{rootdata/resnet50ma.csv}\gdatatable
		...
		\end{subfigure}
		\caption[ResNet-50 \Glsfmtshort{ilsvrc} results]{\textbf{ResNet-50 \glsfmtshort{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
	...
	\subsubsection{ResNet 200}\label{resnet200results}
	\begin{table}[tp]
		\caption[ResNet 200 \Glsfmtshort{ilsvrc} results]{\textbf{ResNet-200 \glsfmtshort{ilsvrc} Results}}
	...
	\begin{figure}[tbp]
		\centering
		\begin{subfigure}[b]{\textwidth}
			\pgfplotstableread[col sep=comma]{rootdata/resnet200orig.csv}\gdatatable
			\pgfplotstableread[col sep=comma]{rootdata/resnet200roots.csv}\codatatable
			\pgfplotsset{major grid style={dotted,red}}
			...
			\addplot+[mark=*,
				...
				only marks,
				point meta=explicit symbolic,
			] table[meta=name,x=ma,y expr={\thisrow{top5}*100},]{\gdatatable};
			\addplot+[mark=square*,
				nodes near coords, nodes near coords align = {below}, only marks,
				every node near coord/.append style={inner sep=4pt},
				only marks,
				point meta=explicit symbolic,
			] table[meta=name,x=ma,y expr={\thisrow{top5}*100},]{\codatatable};
			\legend{ResNet 50, Roots}
			\end{axis}
			\end{tikzpicture}
			\caption{Model Parameters \vs Top-5 Error}
		...
		\end{subfigure}
		\caption[ResNet-200 \Glsfmtshort{ilsvrc} results]{\textbf{ResNet-200 \glsfmtshort{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
		\label{fig:resnet200plots}
	\end{figure}
	To show that the method applies to deeper architectures, we also applied our method to \gls{resnet}\index{ResNet} 200, the deepest network for ILSVRC 2012. To provide a baseline we used code implementing full training augmentation to achieve state-of-the-art results\footnote{\url{https://github.com/facebook/fb.resnet.torch}}. \cref{table:resnet200imagenetresults} and \cref{fig:resnet200plots} show the results, top-1 and top-5 error are for center cropped images. The models trained with roots have comparable or lower error, with fewer parameters and less computation. The root-64 model has 27\% fewer FLOPS and 48\% fewer parameters than \gls{resnet}\index{ResNet} 200.

	\subsection{Improving GoogLeNet on \Glsfmtshort{ilsvrc}}
	\label{googlenet50results}
	\begin{table}[tp]
		\caption[GoogLeNet \Glsfmtshort{ilsvrc} results]{\textbf{GoogLeNet \glsfmtshort{ilsvrc} Results.}}
		...
		highlight col min ={\data}{Param.}, 
		highlight col min ={\data}{Multiply-Acc.}, 
		column type/.add={@{}lp{4em}p{4em}rrrr@{}}{},
		%column type/.add={@{}lp{3em}p{3em}p{3em}p{3em}p{3em}p{3em}@{}}{},
		col sep=comma]{\data}
		%}
	\end{table}
	...
	\begin{table}[tp]
		\caption[GoogLeNet root architectures]{\textbf{GoogLeNet}. Filter groups\index{filter groups} in each conv.\ layer and \Gls{inception}\index{inception} module (\textit{incp}.)}
	...
	\begin{figure}[p]
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmtshort{flops} (Multiply-Add) \vs Top-5 Error.}}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmtshort{gpu} Forward Time \vs Top-5 Error.}}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmtshort{cpu} Forward Time \vs Top-5 Error.}}
			\label{fig:googlenet50cpuforward}
		\end{subfigure}
		
		\caption[GoogLeNet \Glsfmtshort{ilsvrc} results]{\textbf{GoogLeNet \glsfmtshort{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
	...
	While these results may seem modest compared to the results for \gls{resnet}\index{ResNet}, \gls{googlenet}\index{GoogLeNet} is by far the smallest and fastest near state-of-the-art model \gls{ilsvrc} model. We believe that more experimentation in using different cardinalities of filter group\index{filter groups}ing in the heterogeneously-sized filter groups\index{filter groups} within each \gls{inception}\index{inception} module will improve results further.
	...
	\begin{figure}[tbp]
		...
		\begin{subfigure}[b]{0.97\linewidth}	
			...
			\addplot+ table [x expr=\coordindex,y=MA]{\datatable};
		...
		\begin{subfigure}[b]{0.97\linewidth}
			...
			\addplot+ table [x expr=\coordindex,y=param,]{\datatable};
			\addplot+ table [x expr=\coordindex,y=param,]{\datatablea};
			\end{axis}
			\end{tikzpicture}
			
		\end{subfigure}
		\caption[ResNet 50 layer-wise \glsfmtshort{flops}/parameters]{\textbf{ResNet 50 Layer-wise \glsfmtshort{flops}/Parameters.} 
		}
	...
	Our experiments show that our method can achieve a significant reduction in \gls{cpu} and \gls{gpu} runtimes for state-of-the-art \glspl{cnn}\index{CNN} without compromising accuracy. However, the reductions in \gls{gpu} runtime were smaller than might have been expected based on theoretical predictions of computational complexity (FLOPs). We believe this is largely a consequence of the optimization of Caffe for existing network architectures (particularly AlexNet and GoogLeNet) that do not use a high degree of filter group\index{filter groups}ing.
