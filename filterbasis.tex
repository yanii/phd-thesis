...
\begin{document}
	...
	\afterpage{%
	    \begin{landscape}
			\begin{figure}[p]
				...
				\end{subfigure}
				\caption[Intra-layer filter correlation]{\textbf{\Glsfmttext{nin} Intra-Layer Correlation.} Absolute correlation of filters within each layer of a NiN model variant.}
				\label{fig:nincorr}
			\end{figure}
		\end{landscape}
		\begin{landscape}
			\begin{figure}[p]
				...
				\end{subfigure}
				\caption[Inter-layer covariance (all layers)]{\textbf{\Glsfmttext{nin} Inter-layer Covariance.} The inter-layer covariance for all layers in variants of the NiN network.}
	...
	\begin{table}[tp]
		\caption[ResNet 50 \Glsfmttext{ilsvrc} Results]{\textbf{ResNet 50 Results.}}
	...
	\begin{figure}[p]
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\Glsfmttext{flops} (Multiply-Add) \vs Top-5 Error}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\Glsfmttext{gpu} Forward Time \vs Top-5 Error}
		...
		\end{subfigure}
		\caption[ResNet-50 \Glsfmttext{ilsvrc} results]{\textbf{ResNet-50 \glsfmttext{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
	...
	\begin{table}[tp]
		\caption[ResNet 200 \Glsfmttext{ilsvrc} results]{\textbf{ResNet-200 \glsfmttext{ilsvrc} Results}}
	...
	\begin{figure}[tbp]
		...
		\end{subfigure}
		\caption[ResNet-200 \Glsfmttext{ilsvrc} results]{\textbf{ResNet-200 \glsfmttext{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
	...
	\subsection{Improving GoogLeNet on \Glsfmttext{ilsvrc}}
	\label{googlenet50results}
	\begin{table}[tp]
		\caption[GoogLeNet \Glsfmttext{ilsvrc} results]{\textbf{GoogLeNet \glsfmttext{ilsvrc} Results.}}
	...
	\begin{figure}[p]
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmttext{flops} (Multiply-Add) \vs Top-5 Error.}}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmttext{gpu} Forward Time \vs Top-5 Error.}}
		...
		\begin{subfigure}[b]{\textwidth}
			...
			\end{axis}
			\end{tikzpicture}
			\caption{\textbf{\Glsfmttext{cpu} Forward Time \vs Top-5 Error.}}
			\label{fig:googlenet50cpuforward}
		\end{subfigure}
		
		\caption[GoogLeNet \Glsfmttext{ilsvrc} results]{\textbf{GoogLeNet \glsfmttext{ilsvrc} Results.} Models with filter groups\index{filter groups} have fewer parameters, and less floating point operations, while maintaining error comparable to the baseline.}
	...
	\begin{figure}[tbp]
		...
		\end{subfigure}
		\caption[ResNet 50 layer-wise \glsfmttext{flops}/parameters]{\textbf{ResNet 50 Layer-wise \glsfmttext{flops}/Parameters.} 
		}
